...
Many of the people who are actively developing Pegex, hangout on the C<#pegex> IRC channel on C<irc.freenode.net>. Stop by. We'd love to chat with you!

Note, if you are unfamiliar with IRC, there's a really simple way to get started. Simply click this link: L<http://webchat.freenode.net/>. Then, Just enter a nickname, enter '#pegex' for the channel, and enter the captcha. You will be connected and you type stuff in the input box at the bottom of the screen.  After you type something, hit the Enter key, and your text will be sent. Try it!

=head2 The examples Directory

The Pegex git-repository/code-base is here: L<https://github.com/ingydotnet/pegex-pm>. It contains a directory of example parsers:
